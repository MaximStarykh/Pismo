        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  else  if(uName.isEmpty()){
                    ...
                    mFirebaseAuth.createUserWithEmailAndPassword(email, pwd).addOnCompleteListener(RegActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(RegActivity.this,"Щось пішло не так, спробуйте пізніше",Toast.LENGTH_SHORT).show();
                            }
                            else {
